      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-serif font-bold mb-4">Luna Luxe</h3>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative w-16 h-8">
                <Image
                  src="/placeholder.svg?height=30&width=60&text=M-Pesa"
                  alt="M-Pesa payment method accepted"
                  fill
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="tel:+254112081866" className="hover:text-white transition-colors">
                  +254 112081866
                </a>
              </li>
              <li>
                <a href="mailto:1kihiupaul@gmail.com" className="hover:text-white transition-colors">
                  1kihiupaul@gmail.com
                </a>
              </li>
              <li>Luna Luxe Fashion House</li>
              <li>Nairobi, Kenya</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-gray-400 text-sm">Copyright © 2025 All rights reserved | Luna Luxe</div>
        </div>
      </div>
    </footer>
  )
